workspace(name = "cmwell_sdk")

local_repository(
    name = "golang_sdk",
    path = "projects/golang-sdk",
)

local_repository(
    name = "node_sdk",
    path = "projects/node-sdk",
)
...
register_toolchains("@scala_sdk//:cm_well_scala_toolchain")
...
## Scala SDK dependencies ##

load("@scala_sdk//:deps.bzl",
    "project_deps",
    "project_test_deps",
...
maven_install(
    ...
    maven_install_json = "@cmwell_sdk//:maven_install.json",
    repositories = [
